...
const slides = [
  {
    ...
    icon: "qrcode-scan",
    iconType: "material",
    tag: "SIGNED QR VERIFICATION",
    title: "Scan VAFPQR Codes",
    body:
      "The verification server checks each issued QR code's signature, expiry, and current status before showing its destination.",
    card: "#10285A",
    tagBg: "#174987",
    tagText: "#A8CFFF",
  ...
  },
  {
    ...
    iconType: "material",
    tag: "CLEAR VERIFICATION RESULTS",
    title: "Recognize QR Code Status",
    body:
      "Receive a clear warning when a QR code is invalid, expired, blacklisted, or flagged as suspicious.",
    card: "#221C1D",
    tagBg: "#5B3C10",
  ...
  },
  {
    ...
    icon: "flag",
    iconType: "feather",
    tag: "TAMPER REPORTING",
    title: "Report Suspicious Codes",
    body:
      "Submit a description and optional photo or location so administrators can review possible QR code tampering.",
    card: "#073434",
    tagBg: "#0B5F4F",
    tagText: "#65FFD5",
